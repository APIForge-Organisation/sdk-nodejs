...
class CloudTransport {
  ...
  write(rows) {
    ...
    const metrics = rows.map(r => ({
      ...
      calls_3xx:        r.status_3xx     ?? 0,
      calls_4xx:        r.status_4xx,
      calls_5xx:        r.status_5xx,
      status_dist:      r.status_dist    ?? null,
      lat_p50:          r.lat_p50        ?? null,
      lat_p90:          r.lat_p90        ?? null,
      lat_p99:          r.lat_p99        ?? null,
      lat_avg:          r.lat_avg        ?? null,
      lat_ttfb_p50:     r.lat_ttfb_p50   ?? null,
      lat_ttfb_p90:     r.lat_ttfb_p90   ?? null,
      lat_ttfb_p99:     r.lat_ttfb_p99   ?? null,
      bytes_avg:        r.bytes_avg      ?? null,
      request_size_avg: r.request_size_avg ?? null,
      inflight_avg:     r.inflight_avg   ?? null,
      inflight_max:     r.inflight_max   ?? null,
